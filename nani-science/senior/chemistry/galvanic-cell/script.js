...
// ----------------------------------------------------
const quizData = [
  {q:'1. 關於鋅銅電池放電時的微觀變化，下列哪一項敘述正確？',opts:['A. 電子由鋅極經外導線流向銅極，檢流計指針向右（銅極）偏轉','B. 負極的鋅原子失去電子變成鋅離子進入溶液，使負極板質量減輕','C. 正極水溶液中的大分子硫酸根離子（SO₄²⁻）穿越鹽橋流向負極','D. 放電後右側正極杯中的藍色因銅離子濃度增加而變深'],a:'B',r:'負極（Zn）發生氧化反應：Zn→Zn²⁺+2e⁻，鋅原子溶解故極板質量減輕。電子從鋅→銅（左→右），傳統電流從銅→鋅（右→左），故指針向左偏轉。鹽橋中移動的是其內部的K⁺和NO₃⁻，不是外面的SO₄²⁻。'},
  {q:'2. 突然將鹽橋由燒杯中拔除後，有關電池內外粒子運動的敘述，何者正確？',opts:['A. 外導線的電子流靠殘餘電位差持續流動數分鐘','B. Zn²⁺與Cu²⁺開始透過空氣跨杯擴散','C. 反應立即停止，外導線電子流與溶液內離子定向移動皆瞬間靜止','D. 鹽橋移除相當於外導線斷路，但溶液內的氧化還原反應加速'],a:'C',r:'拔除鹽橋破壞內電路的電中性維持機制，兩側溶液無法再進行電荷補償，導致內外電路同時斷路，電池的化學反應與粒子定向移動瞬間完全停止。'},
  {q:'3. 鹽橋在電池中的主要功能為何？',opts:['A. 提供電子流通的路徑','B. 維持兩側溶液的電中性，確保電流持續流動','C. 加速電極上的氧化還原反應速率','D. 防止兩種溶液混合而發生直接化學反應'],a:'B',r:'鹽橋（通常含KNO₃飽和溶液）的主要功能是：陽離子K⁺流向正極（補償Cu²⁺減少），陰離子NO₃⁻流向負極（補償Zn²⁺增加），使兩側溶液維持電中性，電路才能持續導通。'},
  {q:'4. 鋅銅電池持續放電一段時間後，右側CuSO₄溶液的外觀會如何變化？',opts:['A. 顏色由藍色變深，因為Cu²⁺濃度增加','B. 顏色由藍色逐漸變淺，因為Cu²⁺被還原成固體Cu沉積在銅極上','C. 溶液出現白色沉澱','D. 顏色不變，因為反應只發生在電極表面'],a:'B',r:'正極（Cu）發生還原反應：Cu²⁺+2e⁻→Cu，藍色的Cu²⁺不斷被還原成固體Cu沉積在銅電極上，故溶液中Cu²⁺濃度降低，藍色逐漸變淡。'},
  {q:'5. 若以鋅板和鐵板分別插入稀硫酸中，以導線連接組成電池。請問哪一個是負極（陽極）？',opts:['A. 鐵板，因為鐵比鋅活潑','B. 鋅板，因為鋅的活性比鐵大，較容易失去電子','C. 兩者都可以作為負極','D. 稀硫酸中無法構成電池'],a:'B',r:'在電化學中，活性較大（還原電位較低）的金屬作為負極（陽極），發生氧化反應失去電子。鋅的活性大於鐵，故鋅板為負極（Zn→Zn²⁺+2e⁻），鐵板為正極（2H⁺+2e⁻→H₂↑）。'},
  {q:'6. 電解槽與電化學電池（伽凡尼電池）的最根本差異為何？',opts:['A. 電解槽使用液體電解質，電池使用固體電解質','B. 電池將化學能轉換為電能（自發）；電解槽利用外加電能驅動非自發的化學反應','C. 兩者的電子流方向完全相反','D. 電解槽沒有正負極之分'],a:'B',r:'電化學電池（如鋅銅電池）是自發反應，化學能→電能；電解槽是非自發的，需要外加電能才能驅動氧化還原反應（如電鍍、電解水）。兩者都有陰陽極，但陽極和陰極的定義在兩類裝置中剛好相反。'},
  {q:'7. 以鋅銅電池發電時，外導線中的電流方向為何？',opts:['A. 從鋅極流向銅極','B. 從銅極流向鋅極','C. 在外導線中無電流，只有溶液中有電流','D. 交流電，方向不斷交替'],a:'B',r:'電子從鋅極（負極）經外導線流向銅極（正極）——這是電子的流向。傳統電流方向與電子流向相反，因此傳統電流從銅極→外導線→鋅極，即從正極流向負極。'},
  {q:'8. 下列哪種情況可以使電化學電池的電動勢（EMF）增大？',opts:['A. 縮短外導線的長度','B. 選用活性差距更大的兩種金屬作為電極','C. 增加鹽橋中溶液的體積','D. 將兩側溶液的濃度都稀釋一倍'],a:'B',r:'電池的電動勢主要由兩種電極金屬的「標準還原電位差」決定。選用活性（還原電位）差距越大的金屬組合，電位差越大，電動勢越高，電池推動電流的能力越強。'},
  {q:'9. 電解水（2H₂O→2H₂+O₂）屬於哪種能量轉換，且此反應是否自發？',opts:['A. 化學能→電能，自發反應','B. 電能→化學能，非自發反應（需外加電能驅動）','C. 熱能→化學能，自發反應','D. 化學能→熱能，非自發反應'],a:'B',r:'電解水是電解槽的典型應用，需要外加電能才能將水分解為氫氣和氧氣——這是非自發的反應（ΔG>0）。能量轉換方向是電能→化學能（儲能），與電化學電池（化學能→電能）相反。'},
  {q:'10. 在鋅銅電池中，若將ZnSO₄溶液換成純水，對電池有何影響？',opts:['A. 電池依然正常運作，因為有鹽橋補充離子','B. 電池性能下降但仍可發電','C. 電池幾乎無法運作，因為純水導電性極差，內電路電阻極大','D. 鋅極反應速率加快，電池電壓升高'],a:'C',r:'電池的內電路需要靠溶液中的離子（ZnSO₄中的Zn²⁺和SO₄²⁻）傳遞電荷。純水的電離程度極低（[H⁺]=[OH⁻]=10⁻⁷ mol/L），導電性接近絕緣體，會使內電路電阻極大，電流幾乎無法通過。'}
];
